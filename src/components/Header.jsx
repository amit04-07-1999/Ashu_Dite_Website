...
const Header = () => {
  ...
  const InfoContent = () => (
    <>
      <a href="tel:+15551234567" className="flex items-center space-x-2 hover:text-orange-100 transition-colors duration-300 flex-shrink-0">
      ...
      <a href="mailto:info@nutricareclinic.com" className="flex items-center space-x-2 hover:text-orange-100 transition-colors duration-300 flex-shrink-0">
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
