...
const HeroSection = () => {
  return (
    <section className="relative bg-gradient-to-r from-orange-50 to-orange-100 py-24 md:py-36 lg:py-40">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="relative animate-fadeIn mt-12 md:mt-0">
            ...
            <div className="absolute top-10 right-10 w-72 h-72 bg-orange-200 rounded-full opacity-20 blur-3xl"></div>
          </div>
        </div>
      </div>
    </section>
