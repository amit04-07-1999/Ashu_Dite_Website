                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-10">
                  ...
                  {submitStatus === 'success' && (
                    <div className="mb-6 p-4 bg-orange-50 border border-orange-200 rounded-lg flex items-center">
                      ...
                      <p className="text-orange-400">Thank you! Your message has been sent successfully. We'll get back to you soon!</p>
                    </div>
                  )}
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className={`w-full bg-gradient-to-r from-orange-500 to-orange-500 text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center ${
